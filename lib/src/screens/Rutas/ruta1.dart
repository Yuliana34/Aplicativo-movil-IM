...
class MapRutasPage extends StatefulWidget{
   MapRutasPage({Key? key}) : super(key: key);

  _MapRutasPageState createState() => _MapRutasPageState();
}

class _MapRutasPageState extends State<MapRutasPage>{
    ...
    return  Scaffold(
      ...
      children: [
        ...
        Container(
          ...
          child: Text('Tiempo aproximado de llegada, 00:00:5:20'),
        ),
        Padding(
        ...
        Container(
          padding: EdgeInsets.symmetric(horizontal: 16.0),
          alignment: Alignment.bottomLeft,
          child: Text('Tiempo aproximado de llegada: 00:00:02:20'),
        ),
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 16.0),
          child: Divider(
        ...
        Container(
          padding: EdgeInsets.symmetric(horizontal: 16.0),
          alignment: Alignment.bottomLeft,
          child: Text('Tiempo aproximada de llegada: 00:00:35:27'),
        ),
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 16.0),
          child: Divider(
        ...
        Container(
          padding: EdgeInsets.symmetric(horizontal: 16.0),
          alignment: Alignment.bottomLeft,
          child: Text('Tiempo aproximado de llegada: 00:00:20:00'),
        ),
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 16.0),
          child: Divider(
        ...
        Container(
          padding: EdgeInsets.symmetric(horizontal: 16.0),
          alignment: Alignment.bottomLeft,
          child: Text('Tiempo aproximado de llegada: 00:00:35:27'),
        ),
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 16.0),
          child: Divider(
